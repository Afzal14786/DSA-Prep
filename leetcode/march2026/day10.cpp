// Question Link : https://leetcode.com/problems/find-all-possible-stable-binary-arrays-ii/description/?envType=daily-question&envId=2026-03-10
...
public:
    int numberOfStableArrays(int zero, int one, int limit) {
        ...
        vector<vector<array<long,2>>> dp(
            zero+1, vector<array<long,2>>(one+1,{0,0}));
